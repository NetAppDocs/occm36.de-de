...
+
Informationen über die Konfiguration eines Ziel-Volume für den Datenzugriff finden Sie unter http://["ONTAP 9 Express Guide für die Disaster Recovery von Volumes"^].
...
+
Anweisungen hierzu finden Sie im http://["ONTAP 9 Volume Move Express Guide"^].
